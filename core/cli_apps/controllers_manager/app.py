...
from core.cli_apps.controllers_manager.service import ControllerService
...
class ControllersManagerCLI(GenericCLI):
    ...
    def new_auth_controller(self, ctx: ApplicationContext,
                            ...
                            controller_dir: str = OptionCMD("--dir", "-d", default="controllers",
                                                       required=False)):
        controller_service.build_auth_controller(ctx, controller_name, controller_dir, entity_module)