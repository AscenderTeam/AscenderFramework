...
class ControllerCreator:
    def __init__(self, controller_name: str, controller_path: str = "controllers") -> None:
        ...
        self.auth_controller_constants = AuthorizationConstants(controller_name, controller_path)
    ...
    def create_authentication_controller(self) -> Generator[str, None, None]:
        path_manager = Path(self.controller_constants.controllers_path, self.controller_constants.controller_name.lower())
        ...
        # Handle files
        mandatory_files = self.auth_controller_constants.get_mandatory_files()
